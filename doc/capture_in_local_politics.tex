...
\input{../tables/tblA1.tex}
\input{../tables/tblA2.tex}
...
\input{../tables/tblA3.tex}
\input{../tables/tblA4.tex}
...
\input{../tables/tblA6.tex}
\captionof{table}{Intent-to-treat effects}
\label{tab: itt}

\clearpage
\input{../tables/tblA7.tex}
\captionof{table}{Complier average causal effects}
\label{tab: cace}

\input{../tables/tblA8.tex}

\input{../tables/tblA9.tex}
\input{../tables/tblA10.tex}

\clearpage
\input{../tables/tblA11.tex}
\captionof{table}{Conditional complier average causal effect}
\label{tab: cate}

\input{../tables/tblA12.tex}
...
\input{../tables/tblA13.tex}

\input{../tables/tblA14.tex}
